...
I=function(x){return x};K=function(x){return function(){return x}};id=I;constfn=K;Function.S=function(f,g){f=Function.toFunction(f);g=Function.toFunction(g);return function(){return f.apply(this,[g.apply(this,arguments)].concat(Array.slice(arguments,0)));}}
